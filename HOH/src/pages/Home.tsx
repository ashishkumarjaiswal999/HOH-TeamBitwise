  ...
  return (
    <Layout>
        ...
        <div className="container px-4">
          <div className="max-w-3xl mx-auto text-center space-y-6">
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-2xl mx-auto">
              ...
              NGOs get priority. Everyone wins. No login required.
            </p>
        ...
        <div className="container px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            <Card className="p-6 space-y-4 border-2 hover:border-primary/50 transition-colors">
              ...
              <h3 className="text-xl font-semibold">1. List Without Login</h3>
              <p className="text-muted-foreground">
                Choose your tier (A: worn, B: good quality), upload photos, verify via OTP. 
            ...
            <Card className="p-6 space-y-4 border-2 hover:border-ngo-priority/50 transition-colors">
              ...
              <p className="text-muted-foreground">
                Verified NGOs get first access for 2 hours at fixed prices (₹50 for A, ₹225 for B). 
      ...
      <section className="py-16 md:py-24 bg-muted/30">
        <div className="container px-4">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">Fair, Fixed Pricing</h2>
            <p className="text-muted-foreground text-lg max-w-2xl mx-auto">
              Two simple tiers. You set your price within the band. Buyers pay a fixed platform price.
            </p>
          </div>

          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <Card className="p-8 space-y-4 border-2 border-tier-a/30 bg-tier-a-light/50">
              <TierBadge tier="A" />
              <h3 className="text-2xl font-bold">Old / Worn-Out</h3>
              <div className="space-y-2">
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-bold text-tier-a">₹10-30</span>
            ...
            <Card className="p-8 space-y-4 border-2 border-tier-b/30 bg-tier-b-light/50">
              ...
              <div className="space-y-2">
                <div className="flex items-baseline gap-2">
                  <span className="text-3xl font-bold text-tier-b">₹50-100</span>
                  <span className="text-muted-foreground">You earn</span>
                </div>
                <div className="flex items-baseline gap-2">
